...
const Alldata = () => {
  ...
  useEffect(() => {
    axios.get("https://backend-chi-ivory.vercel.app/getproducts")
      .then(response => {
        ...
        {products.map(product => (
          ...
          className=" border-b-2 rounded-md w-60">
            ...
            <div className=" w-full h-52 flex items-center justify-center ">
              <img src={`https://backend-chi-ivory.vercel.app/Images/${product.file}`} alt={product.name} className="w-full object-cover" />
            </div>
